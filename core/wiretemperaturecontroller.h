#ifndef WIRETEMPERATURECONTROLLER_H
#define WIRETEMPERATURECONTROLLER_H
...
class WireTemperatureController : public QObject
{
    Q_OBJECT
public:
    explicit WireTemperatureController(MachineCommunication* communicator);
