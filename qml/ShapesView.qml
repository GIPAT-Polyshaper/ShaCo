        ...
        delegate: Item {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    theShape.durationStr = durationMin + ":" + (durationSec < 10 ? "0" + durationSec : durationSec)
                    theShape.panelSize = workpieceDimX + "x" + workpieceDimY
                    theShape.otherInfo = "Working time: " + theShape.durationStr + "<br>Panel size: " +
                            theShape.panelSize;
                }
                ...
                onPositionChanged: {
                    ...
                    var durationMin = Math.floor(duration / 60)
                    var durationSec = duration % 60
                    var durationStr = durationMin + ":" + (durationSec < 10 ? "0" + durationSec : durationSec)
                    var panelSize = workpieceDimX + "x" + workpieceDimY
                    detailsDialog.shapeOtherInfo = "Working time: " + durationStr + "<br>Panel size: " +
                            panelSize;
                }
